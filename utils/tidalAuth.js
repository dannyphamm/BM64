...
const TIDAL_CLIENT_ID = config.tidalAuthClientID;
const TIDAL_CLIENT_SECRET = config.tidalAuthClientSecret;
...
function requireTidalAuthCredentials() {
	if (!TIDAL_CLIENT_ID || !TIDAL_CLIENT_SECRET) {
		throw new Error('Missing tidalAuthClientID / tidalAuthClientSecret in config.json');
	}
}
